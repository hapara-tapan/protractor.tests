//smoke test google dashboard domain management
describe('dmgoogledashboardsmoketest',function() {
	...
	beforeAll(function() {
		    ...
		    var tdurl = 'https://hydra-test-dot-hapara-dashboard.appspot.com/#/td/hscriptsept2bau-2016@hcheckdm.zawadzki.co.nz/dashboard//';
	...
	it('[DM]should change the line count', function() {
	...
	it('[DM]should sort students by name', function() {
	...
	it('[DM]should filter based on groups', function() {
		//var studentpanel = element(by.css('student-panel:nth-child(1) > div'));
	...
	it('[DM]should verify smartshare button is present', function() {
	...
	it('[DM]should hover over a document and verify that an image pops up', function() {
	...
	it('[DM]should navigate to various tabs on dashboard', function() {
		//define elements
	...
	it('[DM]should go to Gmail', function() {
		//define elements
	...
	it('[DM]should go to Sharing', function() {
	...
	it('[DM]should perform navigate,search,favorite and unfavorite actions on classes', function() {
	...
	it('[DM]should edit a class', function() {
		var mngclassdropdown = element(by.css('[ng-mouseover="openClassesDropdown()"]'));
		var dashhome = element(by.css('[data-action="manage-classes"]'));
		...
		editclass.click();
		nickname.clear();
		nickname.sendKeys("HScript SEPT2 BAU - 2016");
		colorblue.click();
		save.click();
		browser.sleep(2000);
