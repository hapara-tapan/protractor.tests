//smoke test google dashboard single domain
describe('singledashboardsmoketest',function() {
...
beforeAll(function() {
		    ...
		    var tdurl = 'https://hydra-test-dot-hapara-dashboard.appspot.com/#/td/ptorsingle1-1617@ptorsingle.school.hapara.com/dashboard//';

		    browser.ignoreSynchronization = true;
		    browser.driver.manage().window().setSize(1280, 1024);
		    browser.get(googlelogin);
		    email.sendKeys('t1.ptor@ptorsingle.school.hapara.com');
		    next.click();
		    browser.wait(EC.visibilityOf(pwd), 5000);
		    pwd.sendKeys('Hapara1pw!');
		    signin.click();
		    browser.driver.get(tdurl);
			browser.sleep(5000);
		});

	it('[Single]should change the line count', function() {
	...
	it('[Single]should sort students by name', function() {
	...
	it('[Single]should filter based on groups', function() {
		//var studentpanel = element(by.css('student-panel:nth-child(1) > div'));
	...
	it('[Single]should verify smartshare button is present', function() {
	...
	it('[Single]should hover over a document and verify that an image pops up', function() {
	...
	it('[Single]should navigate to various tabs on dashboard', function() {
		//define elements
	...
	it('[Single]should go to Gmail', function() {
		//define elements
	...
	it('[Single]should go to Sharing', function() {
	...
	it('[Single]should perform navigate,search,favorite and unfavorite actions on classes', function() {
	...
	it('[Single]should edit a class', function() {
		var mngclassdropdown = element(by.css('[ng-mouseover="openClassesDropdown()"]'));
		var dashhome = element(by.css('[data-action="manage-classes"]'));
		...
		editclass.click();
		nickname.clear();
		nickname.sendKeys("ptorsingle1-1617");
		colorblue.click();
		save.click();
		browser.sleep(2000);
